...
int main(void) {
    ...
    ifp = fopen("C:/Users/raven/OneDrive/바탕 화면/2-2/Computer Architecture/20493-01-Project-Skeleton/access_input.txt", "r");
    if (ifp == NULL) {
        printf("Can't open input file\n");
        return -1;
    }
    ofp = fopen("C:/Users/raven/OneDrive/바탕 화면/2-2/Computer Architecture/20493-01-Project-Skeleton/access_output.txt", "w");
    if (ofp == NULL) {
